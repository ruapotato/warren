...
static void register_node_classes() {
    ClassBuilder<Node>()
        ...
        .method("add_child", &Node::add_child)
        .method("remove_child", &Node::remove_child)
        .method("queue_free", &Node::queue_free)
        .method("get_parent", &Node::parent)
        .method("get_child_count", &Node::child_count)
        .method("get_child", &Node::child)
        .method("find_child", &Node::find_child)
        .method("get_node", &Node::get_node)
        .method("find_by_class", &Node::find_by_class)
        .method("add_to_group", &Node::add_to_group)
        .method("remove_from_group", &Node::remove_from_group)
        .method("is_in_group", &Node::in_group)
        ...
        .method("print_tree", &Node::to_string_tree, {Variant(0)})
        .signal("tree_entered")
        .signal("tree_exiting");
    ...
    ClassBuilder<Node3D>()
        ...
        .method("translate", &Node3D::translate)
        .method("rotate", &Node3D::rotate)
        .method("look_at", &Node3D::look_at, {Variant(Vec3::up())})
