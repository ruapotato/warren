...
def compile_stage(glslang, spirv_cross, spirv_opt, name, stage, body, preamble,
                  optimise, tmpdir):
    ext, _ = STAGES[stage]
    stage_define = "#define MF_STAGE_%s 1\n" % stage.upper()
...
def main():
    ...
    header = ["// GENERATED by tools/gen_shaders.py. Do not edit.",
              ...
              "namespace mf::shaders {", "",
              "struct Blob {",
              "    const char *name;",
              "    ::mf::rhi::ShaderStage stage;",
