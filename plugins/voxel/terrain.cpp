...
static void register_voxel_classes() {
    ClassBuilder<VoxelTerrain3D>()
        ...
        .method("set_viewer", &VoxelTerrain3D::set_viewer)
        .method("set_seed", &VoxelTerrain3D::set_seed)
        .method("dig", &VoxelTerrain3D::dig)
        ...
        .method("height_at", &VoxelTerrain3D::height_at)
        .method("distance_at", &VoxelTerrain3D::distance_at)
        .method("material_at", &VoxelTerrain3D::material_at)
        .method("set_material", &VoxelTerrain3D::set_material)
