...
class MeshBuilder(Object):
    ...
    def add_cylinder_between(self, from_point: Vec3, to_point: Vec3, radius: float, segments: int = 20) -> None: ...
...
class Control(Node):
    ...
    def __init__(self) -> None: ...
    def set_anchors(self, preset: str) -> None: ...
...
class BoneAttachment3D(Node3D):
    ...
    def set_target(self, body: Skinned3D | None) -> None: ...
    def get_target(self) -> Skinned3D | None: ...
...
class CharacterBody3D(Node3D):
    ...
    def last_portal_in(self) -> Portal3D | None: ...
    def last_portal_out(self) -> Portal3D | None: ...
...
class Fluid3D(Node3D):
    ...
    def emit(self, at: Vec3, velocity: Vec3) -> int: ...
    def fill_box(self, a0: Vec3, to: Vec3) -> int: ...
    def clear(self) -> None: ...
    def particle_count(self) -> int: ...
    def surface_chunks(self) -> int: ...
    def take_settled(self) -> list: ...
    def spray(self, at: Vec3, direction: Vec3, rate: float, speed: float, spread: float, dt: float) -> None: ...
...
class Portal3D(Node3D):
    ...
    def __init__(self) -> None: ...
    def admits(self, radius: float, height: float) -> bool: ...
    def admits_radius(self) -> float: ...
...
class RigidBody3D(Node3D):
    ...
    def __init__(self) -> None: ...
    def spawn(self, world: PhysicsWorld | None) -> None: ...
    def release(self) -> None: ...
    def alive(self) -> bool: ...
    def apply_impulse(self, impulse: Vec3) -> None: ...
    def apply_impulse_at(self, impulse: Vec3, world_point: Vec3) -> None: ...
    def apply_force(self, force: Vec3) -> None: ...
    def apply_torque(self, torque: Vec3) -> None: ...
    def wake(self) -> None: ...
    def is_sleeping(self) -> bool: ...
    def body_scale(self) -> float: ...
    def teleport(self, to: Transform3D) -> None: ...
    def set_kinematic(self, on: bool) -> None: ...
    def is_kinematic(self) -> bool: ...
    def set_body_scale(self, value: float) -> None: ...
    def set_layer(self, value: int) -> None: ...
    def warped(self) -> bool: ...
    def carry_to(self, target: Vec3, strength: float = 18, damping: float = 4) -> None: ...
    def align_to(self, target: Quat, strength: float = 12, damping: float = 3) -> None: ...
    def portals_traversed(self) -> int: ...
    def warp_from(self) -> Portal3D | None: ...
    def warp_to(self) -> Portal3D | None: ...
